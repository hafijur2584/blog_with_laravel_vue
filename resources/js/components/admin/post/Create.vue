            ...
            <form role="form">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <input type="file" @change = "changeImage($event)" name="image" :class="{ 'is-invalid': form.errors.has('image') }">
              ...
              <div class="card-footer">
                <button type="submit" @click.prevent="addValue()" class="btn btn-primary">Submit</button>
              </div>
            </form>
          </div>
        </div>
