              ...
              <div class="post-lists">
                <div class="single-list flex-row d-flex">
                  <div class="thumb">
                    ...
                    <img src="/user/img/asset/l1.jpg" alt />
                  </div>
                  <div class="detail">
                    <a href="#">
                      <h4 class="pb-20">
                    ...
                    <p>inappropriate behavior Lorem ipsum dolor sit amet, consecteturinapprop riate behavior Lorem ipsum dolor sit amet, consectetur.</p>
                ...
                <div class="single-list flex-row d-flex">
                  <div class="thumb">
                    ...
                    <img src="/user/img/asset/l2.jpg" alt />
                  </div>
                  <div class="detail">
                    <a href="#">
                      <h4 class="pb-20">
                ...
                <div class="single-list flex-row d-flex">
                  <div class="thumb">
                    ...
                    <img src="/user/img/asset/l3.jpg" alt />
                  </div>
                  <div class="detail">
                    <a href="#">
                      <h4 class="pb-20">
                ...
                <div class="single-list flex-row d-flex">
                  <div class="thumb">
                    ...
                    <img src="/user/img/asset/l4.jpg" alt />
                  </div>
                  <div class="detail">
                    <a href="#">
                      <h4 class="pb-20">
                ...
                <div class="justify-content-center d-flex">
                  <a
                    class="text-uppercase primary-btn loadmore-btn mt-40 mb-60"
                    href="#"
                  >Load More Post</a>
                </div>
              </div>
            ...
            <div class="col-lg-4 sidebar-area">
              ...
              <div class="single_widget recent_widget">
                ...
                <div class="active-recent-carusel">
                  <div class="item">
                    <img src="/user/img/asset/slider.jpg" alt />
                    ...
                    <p>
                      ...
                      <span>
                        <i class="fa fa-heart-o" aria-hidden="true"></i>
                        06
                        <i class="fa fa-comment-o" aria-hidden="true"></i>02
                      </span>
                    </p>
